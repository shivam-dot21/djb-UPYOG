...
import { Header, MultiLink, SubmitBar } from "@djb25/digit-ui-react-components";
...
const ApplicationDetails = () => {
  ...
  dowloadOptions.push({
    ...
    <div>
      ...
      {(appDetailsToShow?.applicationData?.applicationData?.status == "Expired") && <Link to={`/digit-ui/employee/ptr/petservice/revised-application`}  >
