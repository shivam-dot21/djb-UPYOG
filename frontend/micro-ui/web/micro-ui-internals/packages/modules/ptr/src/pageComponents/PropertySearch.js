...
import { FormStep, TextInput, CardLabel, SearchIcon, Dropdown } from "@djb25/digit-ui-react-components";
...
const PropertySearch = ({ t, config, onSelect, userType,formData,renewApplication }) => {
  ...
  let validation = {};
  const [propertyId, setpropertyId] = useState(renewApplication?.propertyId || formData?.propertyDetails?.propertyId || "");
