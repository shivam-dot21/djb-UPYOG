import { CardLabel, CardLabelError, Dropdown, FormStep, LabelFieldPair, RadioOrSelect } from "@djb25/digit-ui-react-components";
...
const VendorAddress = ({ t, config, onSelect, userType, formData, setError, clearErrors, formState }) => {
      ...
      <FormStep config={config} onSelect={onSubmit} t={t}
       ...
       >
        <div>
          ...
          {selectedCity && localities && <CardLabel>{`${t("VENDOR_LOCALITY")} `}</CardLabel>}
