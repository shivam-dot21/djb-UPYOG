import { EmployeeModuleCard, ReceiptIcon } from "@djb25/digit-ui-react-components";
...
const ReportsCard = () => {
  ...
  links = links.filter((link) => (link.roles ? window.Digit.Utils.checkForEmployee(link?.roles) : true));
